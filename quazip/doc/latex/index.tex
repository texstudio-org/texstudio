...
\item win32-\/g++ (MinGW)
\item win32-\/msvc2008 (MS VS 2008 Express, Qt 4.8.1)
...
Just {\tt zlib} and Qt 4. Well, Qt 4 depends on zlib anyway, but you will need zlib headers to compile QuaZIP.\section{Building, testing and installing}\label{index_building}
\begin{DoxyNote}{Note}
...
Binary compatibility isn't guaranteed even between minor releases, but usually it's preserved, thanks to the Pimpl idiom.\section{Testing}\label{index_test}
