  ...
  menuParent(nullptr), menuParentsBar(nullptr), modifyMenuContentsFirstCall(true), pdflatexEdit(nullptr), persistentConfig(nullptr)
{
    ...
    managedToolBars.append(ManagedToolBar("Database", QStringList() << "main/database/newbasefile" << "main/database/solve" << "main/database/insertfile" << "separator" << "main/database/databasefiles" << "main/database/notes" << "separator" << "main/database/tables" << "main/database/paths" << "main/database/backup"));
