...
public:
    ...
    QPixmap renderToImage(int pageNr, QObject *obj, const char *rec, double xres = 72.0, double yres = 72.0, int x = -1, int y = -1, int w = -1, int h = -1, bool cache = true, bool priority = false, bool delayMode = false, Poppler::Page::Rotation rotate = Poppler::Page::Rotate0);
