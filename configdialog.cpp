...
//pagequick
	...
	fmConfig->addCategory(tr("Basic highlighting")) << "normal" <<"background" <<"comment" <<"keyword" <<"extra-keyword" <<"math-keyword" <<"verbatim" <<"numbers" <<"text" <<"environment" <<"structure" <<"escapeseq" ;
