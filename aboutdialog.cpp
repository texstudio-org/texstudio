...
AboutDialog::AboutDialog(QWidget *parent)
	...
	ui.textBrowser->setOpenExternalLinks(true);
        ui.textBrowser->setHtml(QString::fromUtf8("<b>TexmakerX 1.9.3</b><br>Copyright (c) (original TexMaker) 2004-2008 by Pascal Brachet<br>")+
				...
				QString::fromUtf8("Thanks to Frederic Devernay, Denis Bitouzé, Jean-Côme Charpentier, Luis Silvestre, Enrico Vittorini, Aleksandr Zolotarev, David Sichau & Grigory Mozhaev.<br><br>")+
