...
AboutDialog::AboutDialog(QWidget *parent)
	...
	ui.textBrowser->setHtml(tr("<b>TexMakerX 1.9.9a (SVN " SVN_REVISION_NUMBER ")</b><br>Copyright (c) (original TexMaker) 2004-2008 by Pascal Brachet<br>")+
							...
							tr("Thanks to ")+QString::fromUtf8("Frederic Devernay, Denis Bitouzé, Jean-Côme Charpentier, Luis Silvestre, Enrico Vittorini, Aleksandr Zolotarev, David Sichau, Grigory Mozhaev, mattgk, Pavel Fric, András Somogyi & István Blahota.<br><br>")+
