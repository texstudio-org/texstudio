...
AboutDialog::AboutDialog(QWidget *parent)
	...
	ui.textBrowser->setHtml(QString::fromUtf8("<b>TexMakerX 1.9.9 (SVN " SVN_REVISION_NUMBER ")</b><br>Copyright (c) (original TexMaker) 2004-2008 by Pascal Brachet<br>")+
				...
				QString::fromUtf8("Thanks to Frederic Devernay, Denis Bitouzé, Jean-Côme Charpentier, Luis Silvestre, Enrico Vittorini, Aleksandr Zolotarev, David Sichau, Grigory Mozhaev, mattgk, Pavel Fric & András Somogyi.<br><br>")+
