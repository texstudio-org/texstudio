...
Here all the references may be changed by changing "Replace by" and clicking "Replace All". If some references should not be changed, they can be deselected in the pane below.
