...
The option "Files on disk" searches on all the text in tex-files in the same folder like the current document. The folder and the file filter can be changed.
