...
\luaaddplot file "%<filename%>";
\luaaddplot file "%<filename%>", %<λ-expression%>;
\luaaddplot[%<options%>] file "%<filename%>";
\luaaddplot[%<options%>] file "%<filename%>", %<λ-expression%>;

# options passed to \addplot
#keyvals:\luaaddplot#c
