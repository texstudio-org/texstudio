...
\xpatchindexnameformat[entry type]{name}{search}{replace}{success}{failure}
...
\xpatchindexlistformat[entry type]{name}{search}{replace}{success}{failure}
