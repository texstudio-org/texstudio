...
\setmathsfdigitfont{font name}
\setmathsfdigitfont[Options%keyvals]{font name}
\setmathttdigitfont{font name}
\setmathttdigitfont[Options%keyvals]{font name}

#keyvals:\setmathdigitfont,\setmathsfdigitfont,\setmathttdigitfont
Alternate=%<feature%>
Annotation=
AutoFakeBold=%<number%>
