...
\begin{highlightblock}#V
\begin{highlightblock}[options%keyvals]#V
\end{highlightblock}

#keyvals:\begin{highlightblock}
inputpath=%<path%>
aboveskip=##L
belowskip=##L
lineskip=##L
...
\updatehighlight{highlight rules%keyvals}

#keyvals:\updatehighlight#c
label=
name=
classoffset=
macros=
