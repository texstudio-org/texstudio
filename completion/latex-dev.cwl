...
\AtBeginEnvironment{envname}{code}#*
\AtBeginShipout{code}#*
...
\AtEndDocument{code}#*
\AtEndDvi{code}#*
\AtEndEnvironment[label]{envname}{code}#*
\AtEndEnvironment{envname}{code}#*
\AtEndOfClass{code}#*
\AtEndOfPackage{code}#*
\AtNextShipout{code}#*
\BeforeBeginEnvironment[label]{envname}{code}#*
\BeforeBeginEnvironment{envname}{code}#*
