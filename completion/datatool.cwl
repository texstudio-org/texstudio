...
\DTLloaddb{db%specialDef}{filename}#s#%db
\DTLloaddb[options%keyvals]{db%specialDef}{filename}#s#%db
...
\DTLloadrawdb{db%specialDef}{filename}#s#%db
\DTLloadrawdb[options%keyvals]{db%specialDef}{filename}#s#%db
