...
### biblatex-ams v0.1 ###
#ifOption:style=ams-alphabetic
#keyvals:\usepackage/biblatex#c,\ExecuteBibliographyOptions#c
dashed=#true,false
#endkeyvals
#endif

#ifOption:style=ams-numeric
#keyvals:\usepackage/biblatex#c,\ExecuteBibliographyOptions#c
dashed=#true,false
#endkeyvals
#endif
...
citepages=#omit,separate
nonlatinbooktitle#true,false
nonlatinmaintitle#true,false
nonlatintitle#true,false
partsinvols#true,false
shorthandformat=#italic,roman
usetitle#true,false
usexref#true,false
#endkeyvals
# from biblatex-sbl.def (loaded by sbl.bbx)
#include:xpatch
\begrelateddelimmultivolarticle#S
\locationpublisherdelim#S
\multiseriesdelim#S
\oftitlepunct#S
\postnominaldelim#S
\publisherdelim#S
\relateddelimmultivolarticle#S
\reprintdelim#S
\reprintpunct#S
\sblabbrevwidth#S
\seriesnumberdelim#S
...
\titlevolumedelim#S
\totitlepunct#S
\translatedtitlepunct#S
# from sbl.cbx
#include:biblatex-source-division
\abbrev{bibid}#C
\Afullcite[postnote]{bibid}#C
\afullcite[postnote]{bibid}#C
\Afullcite[prenote][postnote]{bibid}#C
\afullcite[prenote][postnote]{bibid}#C
\afullcites(post){bibid}{bibid}#*C
\Afullcites(post){bibid}{bibid}#*C
\afullcites(pre)(post)[post]{bibid}[post]{bibid}#*C
\Afullcites(pre)(post)[post]{bibid}[post]{bibid}#*C
\afullcites(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\Afullcites(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\afullcites(pre)(post){bibid}{bibid}#C
\Afullcites(pre)(post){bibid}{bibid}#C
\Afullcites[post]{bibid}[post]{bibid}#*C
\afullcites[post]{bibid}[post]{bibid}#*C
\afullcites[pre][post]{bibid}[pre][post]{bibid}#*C
\Afullcites[pre][post]{bibid}[pre][post]{bibid}#*C
\Afullcites{bibid}{bibid}#C
\afullcites{bibid}{bibid}#C
\Afullcite{bibid}#C
\afullcite{bibid}#C
\atranscite[postnote]{bibid}#C
\Atranscite[postnote]{bibid}#C
\atranscite[prenote][postnote]{bibid}#C
\Atranscite[prenote][postnote]{bibid}#C
\Atranscites(post){bibid}{bibid}#*C
\atranscites(post){bibid}{bibid}#*C
\atranscites(pre)(post)[post]{bibid}[post]{bibid}#*C
\Atranscites(pre)(post)[post]{bibid}[post]{bibid}#*C
\atranscites(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\Atranscites(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\atranscites(pre)(post){bibid}{bibid}#C
\Atranscites(pre)(post){bibid}{bibid}#C
\Atranscites[post]{bibid}[post]{bibid}#*C
\atranscites[post]{bibid}[post]{bibid}#*C
\atranscites[pre][post]{bibid}[pre][post]{bibid}#*C
\Atranscites[pre][post]{bibid}[pre][post]{bibid}#*C
\atranscites{bibid}{bibid}#C
\Atranscites{bibid}{bibid}#C
\atranscite{bibid}#C
\Atranscite{bibid}#C
\atransfullcite[postnote]{bibid}#C
\Atransfullcite[postnote]{bibid}#C
\Atransfullcite[prenote][postnote]{bibid}#C
\atransfullcite[prenote][postnote]{bibid}#C
\Atransfullcites(post){bibid}{bibid}#*C
\atransfullcites(post){bibid}{bibid}#*C
\atransfullcites(pre)(post)[post]{bibid}[post]{bibid}#*C
\Atransfullcites(pre)(post)[post]{bibid}[post]{bibid}#*C
\Atransfullcites(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\atransfullcites(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\Atransfullcites(pre)(post){bibid}{bibid}#C
\atransfullcites(pre)(post){bibid}{bibid}#C
\Atransfullcites[post]{bibid}[post]{bibid}#*C
\atransfullcites[post]{bibid}[post]{bibid}#*C
\atransfullcites[pre][post]{bibid}[pre][post]{bibid}#*C
\Atransfullcites[pre][post]{bibid}[pre][post]{bibid}#*C
\Atransfullcites{bibid}{bibid}#C
\atransfullcites{bibid}{bibid}#C
\atransfullcite{bibid}#C
\Atransfullcite{bibid}#C
\avolfullcite[postnote]{bibid}#C
\Avolfullcite[postnote]{bibid}#C
\avolfullcite[prenote][postnote]{bibid}#C
\Avolfullcite[prenote][postnote]{bibid}#C
\avolfullcites(post){bibid}{bibid}#*C
\Avolfullcites(post){bibid}{bibid}#*C
\Avolfullcites(pre)(post)[post]{bibid}[post]{bibid}#*C
\avolfullcites(pre)(post)[post]{bibid}[post]{bibid}#*C
\Avolfullcites(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\avolfullcites(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\Avolfullcites(pre)(post){bibid}{bibid}#C
\avolfullcites(pre)(post){bibid}{bibid}#C
\Avolfullcites[post]{bibid}[post]{bibid}#*C
\avolfullcites[post]{bibid}[post]{bibid}#*C
\Avolfullcites[pre][post]{bibid}[pre][post]{bibid}#*C
\avolfullcites[pre][post]{bibid}[pre][post]{bibid}#*C
\avolfullcites{bibid}{bibid}#C
\Avolfullcites{bibid}{bibid}#C
\avolfullcite{bibid}#C
\Avolfullcite{bibid}#C
\Avoltranscite[postnote]{bibid}#C
\avoltranscite[postnote]{bibid}#C
\Avoltranscite[prenote][postnote]{bibid}#C
\avoltranscite[prenote][postnote]{bibid}#C
\Avoltranscites(post){bibid}{bibid}#*C
\avoltranscites(post){bibid}{bibid}#*C
\Avoltranscites(pre)(post)[post]{bibid}[post]{bibid}#*C
\avoltranscites(pre)(post)[post]{bibid}[post]{bibid}#*C
\Avoltranscites(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\avoltranscites(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\Avoltranscites(pre)(post){bibid}{bibid}#C
\avoltranscites(pre)(post){bibid}{bibid}#C
\avoltranscites[post]{bibid}[post]{bibid}#*C
\Avoltranscites[post]{bibid}[post]{bibid}#*C
\avoltranscites[pre][post]{bibid}[pre][post]{bibid}#*C
\Avoltranscites[pre][post]{bibid}[pre][post]{bibid}#*C
\Avoltranscites{bibid}{bibid}#C
\avoltranscites{bibid}{bibid}#C
\Avoltranscite{bibid}#C
\avoltranscite{bibid}#C
\Avoltransfullcite[postnote]{bibid}#C
\avoltransfullcite[postnote]{bibid}#C
\Avoltransfullcite[prenote][postnote]{bibid}#C
\avoltransfullcite[prenote][postnote]{bibid}#C
\Avoltransfullcites(post){bibid}{bibid}#*C
\avoltransfullcites(post){bibid}{bibid}#*C
\avoltransfullcites(pre)(post)[post]{bibid}[post]{bibid}#*C
\Avoltransfullcites(pre)(post)[post]{bibid}[post]{bibid}#*C
\Avoltransfullcites(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\avoltransfullcites(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\Avoltransfullcites(pre)(post){bibid}{bibid}#C
\avoltransfullcites(pre)(post){bibid}{bibid}#C
\avoltransfullcites[post]{bibid}[post]{bibid}#*C
\Avoltransfullcites[post]{bibid}[post]{bibid}#*C
\avoltransfullcites[pre][post]{bibid}[pre][post]{bibid}#*C
\Avoltransfullcites[pre][post]{bibid}[pre][post]{bibid}#*C
\Avoltransfullcites{bibid}{bibid}#C
\avoltransfullcites{bibid}{bibid}#C
\Avoltransfullcite{bibid}#C
\avoltransfullcite{bibid}#C
\bibentrycite{bibid}#*C
\biblistcite{bibid}#*C
\citecollection[postnote]{bibid}#C
\citecollection[prenote][postnote]{bibid}#C
\citecollection{bibid}#C
\Citefullauthor*[postnote]{bibid}#C
\citefullauthor*[postnote]{bibid}#C
\Citefullauthor*[prenote][postnote]{bibid}#C
\citefullauthor*[prenote][postnote]{bibid}#C
...
\citejournal{bibid}#C
\citeseries{bibid}#C
\citeshortauthor*[postnote]{bibid}#C
\Citeshortauthor*[postnote]{bibid}#C
\citeshortauthor*[prenote][postnote]{bibid}#C
\Citeshortauthor*[prenote][postnote]{bibid}#C
\citeshortauthor*{bibid}#C
\Citeshortauthor*{bibid}#C
\citeshortauthor[postnote]{bibid}#C
\Citeshortauthor[postnote]{bibid}#C
\citeshortauthor[prenote][postnote]{bibid}#C
...
\DeclareNestableCiteCommand*{csname}{def}#S
\DeclareNestableCiteCommand{csname}{def}#S
\ffullcite[postnote]{bibid}#C
\Ffullcite[postnote]{bibid}#C
\ffullcite[prenote][postnote]{bibid}#C
\Ffullcite[prenote][postnote]{bibid}#C
\ffullcites(post){bibid}{bibid}#*C
\Ffullcites(post){bibid}{bibid}#*C
\ffullcites(pre)(post)[post]{bibid}[post]{bibid}#*C
\Ffullcites(pre)(post)[post]{bibid}[post]{bibid}#*C
\Ffullcites(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\ffullcites(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\ffullcites(pre)(post){bibid}{bibid}#C
\Ffullcites(pre)(post){bibid}{bibid}#C
\Ffullcites[post]{bibid}[post]{bibid}#*C
\ffullcites[post]{bibid}[post]{bibid}#*C
\Ffullcites[pre][post]{bibid}[pre][post]{bibid}#*C
\ffullcites[pre][post]{bibid}[pre][post]{bibid}#*C
\Ffullcites{bibid}{bibid}#C
\ffullcites{bibid}{bibid}#C
\ffullcite{bibid}#C
\Ffullcite{bibid}#C
\ftfullcite[postnote]{bibid}#C
\Ftfullcite[postnote]{bibid}#C
\Ftfullcite[prenote][postnote]{bibid}#C
\ftfullcite[prenote][postnote]{bibid}#C
\Ftfullcites(post){bibid}{bibid}#*C
\Ftfullcites(pre)(post)[post]{bibid}[post]{bibid}#*C
\Ftfullcites(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\Ftfullcites(pre)(post){bibid}{bibid}#C
\Ftfullcites[post]{bibid}[post]{bibid}#*C
\Ftfullcites[pre][post]{bibid}[pre][post]{bibid}#*C
\Ftfullcites{bibid}{bibid}#C
\ftfullcite{bibid}#C
\Ftfullcite{bibid}#C
\ftranscite[postnote]{bibid}#C
\Ftranscite[postnote]{bibid}#C
\Ftranscite[prenote][postnote]{bibid}#C
\ftranscite[prenote][postnote]{bibid}#C
\ftranscites(post){bibid}{bibid}#*C
\Ftranscites(post){bibid}{bibid}#*C
\ftranscites(pre)(post)[post]{bibid}[post]{bibid}#*C
\Ftranscites(pre)(post)[post]{bibid}[post]{bibid}#*C
\Ftranscites(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\ftranscites(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\ftranscites(pre)(post){bibid}{bibid}#C
\Ftranscites(pre)(post){bibid}{bibid}#C
\Ftranscites[post]{bibid}[post]{bibid}#*C
\ftranscites[post]{bibid}[post]{bibid}#*C
\Ftranscites[pre][post]{bibid}[pre][post]{bibid}#*C
\ftranscites[pre][post]{bibid}[pre][post]{bibid}#*C
\Ftranscites{bibid}{bibid}#C
\ftranscites{bibid}{bibid}#C
\Ftranscite{bibid}#C
\ftranscite{bibid}#C
\Ftransfullcite[postnote]{bibid}#C
\ftransfullcite[postnote]{bibid}#C
\ftransfullcite[prenote][postnote]{bibid}#C
\Ftransfullcite[prenote][postnote]{bibid}#C
\ftransfullcites(post){bibid}{bibid}#*C
\Ftransfullcites(post){bibid}{bibid}#*C
\Ftransfullcites(pre)(post)[post]{bibid}[post]{bibid}#*C
\ftransfullcites(pre)(post)[post]{bibid}[post]{bibid}#*C
\ftransfullcites(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\Ftransfullcites(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\Ftransfullcites(pre)(post){bibid}{bibid}#C
\ftransfullcites(pre)(post){bibid}{bibid}#C
\ftransfullcites[post]{bibid}[post]{bibid}#*C
\Ftransfullcites[post]{bibid}[post]{bibid}#*C
\ftransfullcites[pre][post]{bibid}[pre][post]{bibid}#*C
\Ftransfullcites[pre][post]{bibid}[pre][post]{bibid}#*C
\ftransfullcites{bibid}{bibid}#C
\Ftransfullcites{bibid}{bibid}#C
\Ftransfullcite{bibid}#C
\ftransfullcite{bibid}#C
\fttranscite[postnote]{bibid}#C
\Fttranscite[postnote]{bibid}#C
\Fttranscite[prenote][postnote]{bibid}#C
\fttranscite[prenote][postnote]{bibid}#C
\Fttranscites(post){bibid}{bibid}#*C
\Fttranscites(pre)(post)[post]{bibid}[post]{bibid}#*C
\Fttranscites(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\Fttranscites(pre)(post){bibid}{bibid}#C
\Fttranscites[post]{bibid}[post]{bibid}#*C
\Fttranscites[pre][post]{bibid}[pre][post]{bibid}#*C
\Fttranscites{bibid}{bibid}#C
\Fttranscite{bibid}#C
\fttranscite{bibid}#C
\Fttransfullcite[postnote]{bibid}#C
\fttransfullcite[postnote]{bibid}#C
\Fttransfullcite[prenote][postnote]{bibid}#C
\fttransfullcite[prenote][postnote]{bibid}#C
\Fttransfullcites(post){bibid}{bibid}#*C
\Fttransfullcites(pre)(post)[post]{bibid}[post]{bibid}#*C
\Fttransfullcites(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\Fttransfullcites(pre)(post){bibid}{bibid}#C
\Fttransfullcites[post]{bibid}[post]{bibid}#*C
\Fttransfullcites[pre][post]{bibid}[pre][post]{bibid}#*C
\Fttransfullcites{bibid}{bibid}#C
\fttransfullcite{bibid}#C
\Fttransfullcite{bibid}#C
\ftvolfullcite[postnote]{bibid}#C
\Ftvolfullcite[postnote]{bibid}#C
\ftvolfullcite[prenote][postnote]{bibid}#C
\Ftvolfullcite[prenote][postnote]{bibid}#C
\Ftvolfullcites(post){bibid}{bibid}#*C
\ftvolfullcites(post){bibid}{bibid}#*C
\ftvolfullcites(pre)(post)[post]{bibid}[post]{bibid}#*C
\Ftvolfullcites(pre)(post)[post]{bibid}[post]{bibid}#*C
\Ftvolfullcites(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\ftvolfullcites(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\ftvolfullcites(pre)(post){bibid}{bibid}#C
\Ftvolfullcites(pre)(post){bibid}{bibid}#C
\Ftvolfullcites[post]{bibid}[post]{bibid}#*C
\ftvolfullcites[post]{bibid}[post]{bibid}#*C
\ftvolfullcites[pre][post]{bibid}[pre][post]{bibid}#*C
\Ftvolfullcites[pre][post]{bibid}[pre][post]{bibid}#*C
\ftvolfullcites{bibid}{bibid}#C
\Ftvolfullcites{bibid}{bibid}#C
\Ftvolfullcite{bibid}#C
\ftvolfullcite{bibid}#C
\ftvoltranscite[postnote]{bibid}#C
\Ftvoltranscite[postnote]{bibid}#C
\ftvoltranscite[prenote][postnote]{bibid}#C
\Ftvoltranscite[prenote][postnote]{bibid}#C
\Ftvoltranscites(post){bibid}{bibid}#*C
\ftvoltranscites(post){bibid}{bibid}#*C
\ftvoltranscites(pre)(post)[post]{bibid}[post]{bibid}#*C
\Ftvoltranscites(pre)(post)[post]{bibid}[post]{bibid}#*C
\Ftvoltranscites(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\ftvoltranscites(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\ftvoltranscites(pre)(post){bibid}{bibid}#C
\Ftvoltranscites(pre)(post){bibid}{bibid}#C
\ftvoltranscites[post]{bibid}[post]{bibid}#*C
\Ftvoltranscites[post]{bibid}[post]{bibid}#*C
\ftvoltranscites[pre][post]{bibid}[pre][post]{bibid}#*C
\Ftvoltranscites[pre][post]{bibid}[pre][post]{bibid}#*C
\Ftvoltranscites{bibid}{bibid}#C
\ftvoltranscites{bibid}{bibid}#C
\Ftvoltranscite{bibid}#C
\ftvoltranscite{bibid}#C
\Ftvoltransfullcite[postnote]{bibid}#C
\ftvoltransfullcite[postnote]{bibid}#C
\Ftvoltransfullcite[prenote][postnote]{bibid}#C
\ftvoltransfullcite[prenote][postnote]{bibid}#C
\Ftvoltransfullcites(post){bibid}{bibid}#*C
\ftvoltransfullcites(post){bibid}{bibid}#*C
\Ftvoltransfullcites(pre)(post)[post]{bibid}[post]{bibid}#*C
\ftvoltransfullcites(pre)(post)[post]{bibid}[post]{bibid}#*C
\ftvoltransfullcites(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\Ftvoltransfullcites(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\Ftvoltransfullcites(pre)(post){bibid}{bibid}#C
\ftvoltransfullcites(pre)(post){bibid}{bibid}#C
\Ftvoltransfullcites[post]{bibid}[post]{bibid}#*C
\ftvoltransfullcites[post]{bibid}[post]{bibid}#*C
\ftvoltransfullcites[pre][post]{bibid}[pre][post]{bibid}#*C
\Ftvoltransfullcites[pre][post]{bibid}[pre][post]{bibid}#*C
\ftvoltransfullcites{bibid}{bibid}#C
\Ftvoltransfullcites{bibid}{bibid}#C
\ftvoltransfullcite{bibid}#C
\Ftvoltransfullcite{bibid}#C
\Fullcite[postnote]{bibid}#C
\Fullcite[prenote][postnote]{bibid}#C
\fullcitecmd#S
\fullcites(post){bibid}{bibid}#*C
\Fullcites(post){bibid}{bibid}#*C
\fullcites(pre)(post)[post]{bibid}[post]{bibid}#*C
\Fullcites(pre)(post)[post]{bibid}[post]{bibid}#*C
\fullcites(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\Fullcites(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\fullcites(pre)(post){bibid}{bibid}#C
\Fullcites(pre)(post){bibid}{bibid}#C
\Fullcites[post]{bibid}[post]{bibid}#*C
\fullcites[post]{bibid}[post]{bibid}#*C
\Fullcites[pre][post]{bibid}[pre][post]{bibid}#*C
\fullcites[pre][post]{bibid}[pre][post]{bibid}#*C
\Fullcites{bibid}{bibid}#C
\fullcites{bibid}{bibid}#C
\Fullcite{bibid}#C
\Fvolfullcite[postnote]{bibid}#C
\fvolfullcite[postnote]{bibid}#C
\Fvolfullcite[prenote][postnote]{bibid}#C
\fvolfullcite[prenote][postnote]{bibid}#C
\Fvolfullcites(post){bibid}{bibid}#*C
\fvolfullcites(post){bibid}{bibid}#*C
\Fvolfullcites(pre)(post)[post]{bibid}[post]{bibid}#*C
\fvolfullcites(pre)(post)[post]{bibid}[post]{bibid}#*C
\Fvolfullcites(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\fvolfullcites(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\Fvolfullcites(pre)(post){bibid}{bibid}#C
\fvolfullcites(pre)(post){bibid}{bibid}#C
\Fvolfullcites[post]{bibid}[post]{bibid}#*C
\fvolfullcites[post]{bibid}[post]{bibid}#*C
\fvolfullcites[pre][post]{bibid}[pre][post]{bibid}#*C
\Fvolfullcites[pre][post]{bibid}[pre][post]{bibid}#*C
\Fvolfullcites{bibid}{bibid}#C
\fvolfullcites{bibid}{bibid}#C
\fvolfullcite{bibid}#C
\Fvolfullcite{bibid}#C
\Fvoltranscite[postnote]{bibid}#C
\fvoltranscite[postnote]{bibid}#C
\Fvoltranscite[prenote][postnote]{bibid}#C
\fvoltranscite[prenote][postnote]{bibid}#C
\Fvoltranscites(post){bibid}{bibid}#*C
\fvoltranscites(post){bibid}{bibid}#*C
\Fvoltranscites(pre)(post)[post]{bibid}[post]{bibid}#*C
\fvoltranscites(pre)(post)[post]{bibid}[post]{bibid}#*C
\fvoltranscites(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\Fvoltranscites(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\Fvoltranscites(pre)(post){bibid}{bibid}#C
\fvoltranscites(pre)(post){bibid}{bibid}#C
\Fvoltranscites[post]{bibid}[post]{bibid}#*C
\fvoltranscites[post]{bibid}[post]{bibid}#*C
\fvoltranscites[pre][post]{bibid}[pre][post]{bibid}#*C
\Fvoltranscites[pre][post]{bibid}[pre][post]{bibid}#*C
\Fvoltranscites{bibid}{bibid}#C
\fvoltranscites{bibid}{bibid}#C
\Fvoltranscite{bibid}#C
\fvoltranscite{bibid}#C
\Fvoltransfullcite[postnote]{bibid}#C
\fvoltransfullcite[postnote]{bibid}#C
\fvoltransfullcite[prenote][postnote]{bibid}#C
\Fvoltransfullcite[prenote][postnote]{bibid}#C
\fvoltransfullcites(post){bibid}{bibid}#*C
\Fvoltransfullcites(post){bibid}{bibid}#*C
\fvoltransfullcites(pre)(post)[post]{bibid}[post]{bibid}#*C
\Fvoltransfullcites(pre)(post)[post]{bibid}[post]{bibid}#*C
\Fvoltransfullcites(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\fvoltransfullcites(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\fvoltransfullcites(pre)(post){bibid}{bibid}#C
\Fvoltransfullcites(pre)(post){bibid}{bibid}#C
\fvoltransfullcites[post]{bibid}[post]{bibid}#*C
\Fvoltransfullcites[post]{bibid}[post]{bibid}#*C
\Fvoltransfullcites[pre][post]{bibid}[pre][post]{bibid}#*C
\fvoltransfullcites[pre][post]{bibid}[pre][post]{bibid}#*C
\Fvoltransfullcites{bibid}{bibid}#C
\fvoltransfullcites{bibid}{bibid}#C
\Fvoltransfullcite{bibid}#C
\fvoltransfullcite{bibid}#C
\ifinparens{arg1}{arg2}#S
\mksblsmartfootcite{arg}#S
\parencitecollection[postnote]{bibid}#C
\parencitecollection[prenote][postnote]{bibid}#C
\parencitecollection{bibid}#C
\pfullcite[postnote]{bibid}#C
\Pfullcite[postnote]{bibid}#C
\Pfullcite[prenote][postnote]{bibid}#C
\pfullcite[prenote][postnote]{bibid}#C
\Pfullcite[prenote][postnote]{bibid}#C
\Pfullcite[prenote][postnote]{bibid}#C
\pfullcites(post){bibid}{bibid}#*C
\Pfullcites(post){bibid}{bibid}#*C
\Pfullcites(pre)(post)[post]{bibid}[post]{bibid}#*C
\pfullcites(pre)(post)[post]{bibid}[post]{bibid}#*C
\Pfullcites(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\pfullcites(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\pfullcites(pre)(post){bibid}{bibid}#C
\Pfullcites(pre)(post){bibid}{bibid}#C
\Pfullcites[post]{bibid}[post]{bibid}#*C
\pfullcites[post]{bibid}[post]{bibid}#*C
\Pfullcites[pre][post]{bibid}[pre][post]{bibid}#*C
\pfullcites[pre][post]{bibid}[pre][post]{bibid}#*C
\Pfullcites{bibid}{bibid}#C
\pfullcites{bibid}{bibid}#C
\pfullcite{bibid}#C
\Pfullcite{bibid}#C
\ptranscite[postnote]{bibid}#C
\Ptranscite[postnote]{bibid}#C
\ptranscite[prenote][postnote]{bibid}#C
\ptranscites(post){bibid}{bibid}#*C
\Ptranscites(post){bibid}{bibid}#*C
\ptranscites(pre)(post)[post]{bibid}[post]{bibid}#*C
\Ptranscites(pre)(post)[post]{bibid}[post]{bibid}#*C
\Ptranscites(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\ptranscites(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\ptranscites(pre)(post){bibid}{bibid}#C
\Ptranscites(pre)(post){bibid}{bibid}#C
\Ptranscites[post]{bibid}[post]{bibid}#*C
\ptranscites[post]{bibid}[post]{bibid}#*C
\ptranscites[pre][post]{bibid}[pre][post]{bibid}#*C
\Ptranscites[pre][post]{bibid}[pre][post]{bibid}#*C
\ptranscites{bibid}{bibid}#C
\Ptranscites{bibid}{bibid}#C
\ptranscite{bibid}#C
\Ptranscite{bibid}#C
\Ptransfullcite[postnote]{bibid}#C
\ptransfullcite[postnote]{bibid}#C
\ptransfullcite[prenote][postnote]{bibid}#C
\Ptransfullcites(post){bibid}{bibid}#*C
\ptransfullcites(post){bibid}{bibid}#*C
\Ptransfullcites(pre)(post)[post]{bibid}[post]{bibid}#*C
\ptransfullcites(pre)(post)[post]{bibid}[post]{bibid}#*C
\Ptransfullcites(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\ptransfullcites(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\Ptransfullcites(pre)(post){bibid}{bibid}#C
\ptransfullcites(pre)(post){bibid}{bibid}#C
\ptransfullcites[post]{bibid}[post]{bibid}#*C
\Ptransfullcites[post]{bibid}[post]{bibid}#*C
\Ptransfullcites[pre][post]{bibid}[pre][post]{bibid}#*C
\ptransfullcites[pre][post]{bibid}[pre][post]{bibid}#*C
\ptransfullcites{bibid}{bibid}#C
\Ptransfullcites{bibid}{bibid}#C
\ptransfullcite{bibid}#C
\Ptransfullcite{bibid}#C
\pvolfullcite[postnote]{bibid}#C
\Pvolfullcite[postnote]{bibid}#C
\pvolfullcite[prenote][postnote]{bibid}#C
\Pvolfullcite[prenote][postnote]{bibid}#C
\Pvolfullcites(post){bibid}{bibid}#*C
\pvolfullcites(post){bibid}{bibid}#*C
\Pvolfullcites(pre)(post)[post]{bibid}[post]{bibid}#*C
\pvolfullcites(pre)(post)[post]{bibid}[post]{bibid}#*C
\pvolfullcites(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\Pvolfullcites(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\Pvolfullcites(pre)(post){bibid}{bibid}#C
\pvolfullcites(pre)(post){bibid}{bibid}#C
\Pvolfullcites[post]{bibid}[post]{bibid}#*C
\pvolfullcites[post]{bibid}[post]{bibid}#*C
\pvolfullcites[pre][post]{bibid}[pre][post]{bibid}#*C
\Pvolfullcites[pre][post]{bibid}[pre][post]{bibid}#*C
\pvolfullcites{bibid}{bibid}#C
\Pvolfullcites{bibid}{bibid}#C
\pvolfullcite{bibid}#C
\Pvolfullcite{bibid}#C
\Pvoltranscite[postnote]{bibid}#C
\pvoltranscite[postnote]{bibid}#C
\pvoltranscite[prenote][postnote]{bibid}#C
\Pvoltranscite[prenote][postnote]{bibid}#C
\Pvoltranscites(post){bibid}{bibid}#*C
\pvoltranscites(post){bibid}{bibid}#*C
\pvoltranscites(pre)(post)[post]{bibid}[post]{bibid}#*C
\Pvoltranscites(pre)(post)[post]{bibid}[post]{bibid}#*C
\pvoltranscites(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\Pvoltranscites(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\pvoltranscites(pre)(post){bibid}{bibid}#C
\Pvoltranscites(pre)(post){bibid}{bibid}#C
\pvoltranscites[post]{bibid}[post]{bibid}#*C
\Pvoltranscites[post]{bibid}[post]{bibid}#*C
\Pvoltranscites[pre][post]{bibid}[pre][post]{bibid}#*C
\pvoltranscites[pre][post]{bibid}[pre][post]{bibid}#*C
\pvoltranscites{bibid}{bibid}#C
\Pvoltranscites{bibid}{bibid}#C
\Pvoltranscite{bibid}#C
\pvoltranscite{bibid}#C
\pvoltransfullcite[postnote]{bibid}#C
\Pvoltransfullcite[postnote]{bibid}#C
\Pvoltransfullcite[prenote][postnote]{bibid}#C
\pvoltransfullcite[prenote][postnote]{bibid}#C
\pvoltransfullcites(post){bibid}{bibid}#*C
\Pvoltransfullcites(post){bibid}{bibid}#*C
\pvoltransfullcites(pre)(post)[post]{bibid}[post]{bibid}#*C
\Pvoltransfullcites(pre)(post)[post]{bibid}[post]{bibid}#*C
\Pvoltransfullcites(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\pvoltransfullcites(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\pvoltransfullcites(pre)(post){bibid}{bibid}#C
\Pvoltransfullcites(pre)(post){bibid}{bibid}#C
\pvoltransfullcites[post]{bibid}[post]{bibid}#*C
\Pvoltransfullcites[post]{bibid}[post]{bibid}#*C
\Pvoltransfullcites[pre][post]{bibid}[pre][post]{bibid}#*C
\pvoltransfullcites[pre][post]{bibid}[pre][post]{bibid}#*C
\pvoltransfullcites{bibid}{bibid}#C
\Pvoltransfullcites{bibid}{bibid}#C
\Pvoltransfullcite{bibid}#C
\pvoltransfullcite{bibid}#C
\sblfootquotepunct[punctuation]{entry key}
\sblfootquotepunct{entry key}
\sfullcite[postnote]{bibid}#C
\Sfullcite[postnote]{bibid}#C
\sfullcite[prenote][postnote]{bibid}#C
\Sfullcite[prenote][postnote]{bibid}#C
\Sfullcites(post){bibid}{bibid}#*C
\sfullcites(post){bibid}{bibid}#*C
\Sfullcites(pre)(post)[post]{bibid}[post]{bibid}#*C
\sfullcites(pre)(post)[post]{bibid}[post]{bibid}#*C
\Sfullcites(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\sfullcites(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\Sfullcites(pre)(post){bibid}{bibid}#C
\sfullcites(pre)(post){bibid}{bibid}#C
\sfullcites[post]{bibid}[post]{bibid}#*C
\Sfullcites[post]{bibid}[post]{bibid}#*C
\sfullcites[pre][post]{bibid}[pre][post]{bibid}#*C
\Sfullcites[pre][post]{bibid}[pre][post]{bibid}#*C
\sfullcites{bibid}{bibid}#C
\Sfullcites{bibid}{bibid}#C
\sfullcite{bibid}#C
\Sfullcite{bibid}#C
\stranscite[postnote]{bibid}#C
\Stranscite[postnote]{bibid}#C
\Stranscite[prenote][postnote]{bibid}#C
\stranscite[prenote][postnote]{bibid}#C
\Stranscites(post){bibid}{bibid}#*C
\stranscites(post){bibid}{bibid}#*C
\Stranscites(pre)(post)[post]{bibid}[post]{bibid}#*C
\stranscites(pre)(post)[post]{bibid}[post]{bibid}#*C
\stranscites(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\Stranscites(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\stranscites(pre)(post){bibid}{bibid}#C
\Stranscites(pre)(post){bibid}{bibid}#C
\Stranscites[post]{bibid}[post]{bibid}#*C
\stranscites[post]{bibid}[post]{bibid}#*C
\stranscites[pre][post]{bibid}[pre][post]{bibid}#*C
\Stranscites[pre][post]{bibid}[pre][post]{bibid}#*C
\Stranscites{bibid}{bibid}#C
\stranscites{bibid}{bibid}#C
\stranscite{bibid}#C
\Stranscite{bibid}#C
\stransfullcite[postnote]{bibid}#C
\Stransfullcite[postnote]{bibid}#C
\stransfullcite[prenote][postnote]{bibid}#C
\Stransfullcite[prenote][postnote]{bibid}#C
\stransfullcites(post){bibid}{bibid}#*C
\Stransfullcites(post){bibid}{bibid}#*C
\stransfullcites(pre)(post)[post]{bibid}[post]{bibid}#*C
\Stransfullcites(pre)(post)[post]{bibid}[post]{bibid}#*C
\stransfullcites(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\Stransfullcites(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\stransfullcites(pre)(post){bibid}{bibid}#C
\Stransfullcites(pre)(post){bibid}{bibid}#C
\Stransfullcites[post]{bibid}[post]{bibid}#*C
\stransfullcites[post]{bibid}[post]{bibid}#*C
\stransfullcites[pre][post]{bibid}[pre][post]{bibid}#*C
\Stransfullcites[pre][post]{bibid}[pre][post]{bibid}#*C
\Stransfullcites{bibid}{bibid}#C
\stransfullcites{bibid}{bibid}#C
\stransfullcite{bibid}#C
\Stransfullcite{bibid}#C
\svolfullcite[postnote]{bibid}#C
\Svolfullcite[postnote]{bibid}#C
\Svolfullcite[prenote][postnote]{bibid}#C
\svolfullcite[prenote][postnote]{bibid}#C
\svolfullcites(post){bibid}{bibid}#*C
\Svolfullcites(post){bibid}{bibid}#*C
\Svolfullcites(pre)(post)[post]{bibid}[post]{bibid}#*C
\svolfullcites(pre)(post)[post]{bibid}[post]{bibid}#*C
\svolfullcites(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\Svolfullcites(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\svolfullcites(pre)(post){bibid}{bibid}#C
\Svolfullcites(pre)(post){bibid}{bibid}#C
\svolfullcites[post]{bibid}[post]{bibid}#*C
\Svolfullcites[post]{bibid}[post]{bibid}#*C
\svolfullcites[pre][post]{bibid}[pre][post]{bibid}#*C
\Svolfullcites[pre][post]{bibid}[pre][post]{bibid}#*C
\svolfullcites{bibid}{bibid}#C
\Svolfullcites{bibid}{bibid}#C
\Svolfullcite{bibid}#C
\svolfullcite{bibid}#C
\svoltranscite[postnote]{bibid}#C
\Svoltranscite[postnote]{bibid}#C
\Svoltranscite[prenote][postnote]{bibid}#C
\svoltranscite[prenote][postnote]{bibid}#C
\Svoltranscites(post){bibid}{bibid}#*C
\svoltranscites(post){bibid}{bibid}#*C
\svoltranscites(pre)(post)[post]{bibid}[post]{bibid}#*C
\Svoltranscites(pre)(post)[post]{bibid}[post]{bibid}#*C
\Svoltranscites(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\svoltranscites(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\svoltranscites(pre)(post){bibid}{bibid}#C
\Svoltranscites(pre)(post){bibid}{bibid}#C
\svoltranscites[post]{bibid}[post]{bibid}#*C
\Svoltranscites[post]{bibid}[post]{bibid}#*C
\Svoltranscites[pre][post]{bibid}[pre][post]{bibid}#*C
\svoltranscites[pre][post]{bibid}[pre][post]{bibid}#*C
\svoltranscites{bibid}{bibid}#C
\Svoltranscites{bibid}{bibid}#C
\svoltranscite{bibid}#C
\Svoltranscite{bibid}#C
\svoltransfullcite[postnote]{bibid}#C
\Svoltransfullcite[postnote]{bibid}#C
\Svoltransfullcite[prenote][postnote]{bibid}#C
\svoltransfullcite[prenote][postnote]{bibid}#C
\Svoltransfullcites(post){bibid}{bibid}#*C
\svoltransfullcites(post){bibid}{bibid}#*C
\Svoltransfullcites(pre)(post)[post]{bibid}[post]{bibid}#*C
\svoltransfullcites(pre)(post)[post]{bibid}[post]{bibid}#*C
\Svoltransfullcites(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\svoltransfullcites(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\svoltransfullcites(pre)(post){bibid}{bibid}#C
\Svoltransfullcites(pre)(post){bibid}{bibid}#C
\Svoltransfullcites[post]{bibid}[post]{bibid}#*C
\svoltransfullcites[post]{bibid}[post]{bibid}#*C
\Svoltransfullcites[pre][post]{bibid}[pre][post]{bibid}#*C
\svoltransfullcites[pre][post]{bibid}[pre][post]{bibid}#*C
\Svoltransfullcites{bibid}{bibid}#C
\svoltransfullcites{bibid}{bibid}#C
\Svoltransfullcite{bibid}#C
\svoltransfullcite{bibid}#C
\Transcite[postnote]{bibid}#C
\Transcite[prenote][postnote]{bibid}#C
\transcitecmd#S
\transcites(post){bibid}{bibid}#*C
\Transcites(post){bibid}{bibid}#*C
\Transcites(pre)(post)[post]{bibid}[post]{bibid}#*C
\transcites(pre)(post)[post]{bibid}[post]{bibid}#*C
\Transcites(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\transcites(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\Transcites(pre)(post){bibid}{bibid}#C
\transcites(pre)(post){bibid}{bibid}#C
\transcites[post]{bibid}[post]{bibid}#*C
\Transcites[post]{bibid}[post]{bibid}#*C
\transcites[pre][post]{bibid}[pre][post]{bibid}#*C
\Transcites[pre][post]{bibid}[pre][post]{bibid}#*C
\transcites{bibid}{bibid}#C
\Transcites{bibid}{bibid}#C
\Transcite{bibid}#C
\Transfullcite[postnote]{bibid}#C
\Transfullcite[prenote][postnote]{bibid}#C
\transfullcites(post){bibid}{bibid}#*C
\Transfullcites(post){bibid}{bibid}#*C
\transfullcites(pre)(post)[post]{bibid}[post]{bibid}#*C
\Transfullcites(pre)(post)[post]{bibid}[post]{bibid}#*C
\Transfullcites(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\transfullcites(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\transfullcites(pre)(post){bibid}{bibid}#C
\Transfullcites(pre)(post){bibid}{bibid}#C
\Transfullcites[post]{bibid}[post]{bibid}#*C
\transfullcites[post]{bibid}[post]{bibid}#*C
\Transfullcites[pre][post]{bibid}[pre][post]{bibid}#*C
\transfullcites[pre][post]{bibid}[pre][post]{bibid}#*C
\Transfullcites{bibid}{bibid}#C
\transfullcites{bibid}{bibid}#C
\Transfullcite{bibid}#C
\Volfullcite[postnote]{bibid}#C
\volfullcite[postnote]{bibid}#C
\volfullcite[prenote][postnote]{bibid}#C
\Volfullcite[prenote][postnote]{bibid}#C
\volfullcites(post){bibid}{bibid}#*C
\Volfullcites(post){bibid}{bibid}#*C
\volfullcites(pre)(post)[post]{bibid}[post]{bibid}#*C
\Volfullcites(pre)(post)[post]{bibid}[post]{bibid}#*C
\volfullcites(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\Volfullcites(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\volfullcites(pre)(post){bibid}{bibid}#C
\Volfullcites(pre)(post){bibid}{bibid}#C
\volfullcites[post]{bibid}[post]{bibid}#*C
\Volfullcites[post]{bibid}[post]{bibid}#*C
\volfullcites[pre][post]{bibid}[pre][post]{bibid}#*C
\Volfullcites[pre][post]{bibid}[pre][post]{bibid}#*C
\Volfullcites{bibid}{bibid}#C
\volfullcites{bibid}{bibid}#C
\volfullcite{bibid}#C
\Volfullcite{bibid}#C
\voltranscite[postnote]{bibid}#C
\Voltranscite[postnote]{bibid}#C
\Voltranscite[prenote][postnote]{bibid}#C
\voltranscite[prenote][postnote]{bibid}#C
\voltranscites(post){bibid}{bibid}#*C
\Voltranscites(post){bibid}{bibid}#*C
\voltranscites(pre)(post)[post]{bibid}[post]{bibid}#*C
\Voltranscites(pre)(post)[post]{bibid}[post]{bibid}#*C
\Voltranscites(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\voltranscites(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\voltranscites(pre)(post){bibid}{bibid}#C
\Voltranscites(pre)(post){bibid}{bibid}#C
\voltranscites[post]{bibid}[post]{bibid}#*C
\Voltranscites[post]{bibid}[post]{bibid}#*C
\voltranscites[pre][post]{bibid}[pre][post]{bibid}#*C
\Voltranscites[pre][post]{bibid}[pre][post]{bibid}#*C
\Voltranscites{bibid}{bibid}#C
\voltranscites{bibid}{bibid}#C
\voltranscite{bibid}#C
\Voltranscite{bibid}#C
\Voltransfullcite[postnote]{bibid}#C
\voltransfullcite[postnote]{bibid}#C
\Voltransfullcite[prenote][postnote]{bibid}#C
\voltransfullcite[prenote][postnote]{bibid}#C
\voltransfullcites(post){bibid}{bibid}#*C
\Voltransfullcites(post){bibid}{bibid}#*C
\voltransfullcites(pre)(post)[post]{bibid}[post]{bibid}#*C
\Voltransfullcites(pre)(post)[post]{bibid}[post]{bibid}#*C
\Voltransfullcites(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\voltransfullcites(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\voltransfullcites(pre)(post){bibid}{bibid}#C
\Voltransfullcites(pre)(post){bibid}{bibid}#C
\voltransfullcites[post]{bibid}[post]{bibid}#*C
\Voltransfullcites[post]{bibid}[post]{bibid}#*C
\voltransfullcites[pre][post]{bibid}[pre][post]{bibid}#*C
\Voltransfullcites[pre][post]{bibid}[pre][post]{bibid}#*C
\Voltransfullcites{bibid}{bibid}#C
\voltransfullcites{bibid}{bibid}#C
\Voltransfullcite{bibid}#C
\voltransfullcite{bibid}#C
#endif
