...
\citets(pre){bibid}{bibid}#*C
\citets(pre)(post){bibid}{bibid}#*C
\citets(pre)(post)[pre]{bibid}[pre]{bibid}#*C
\citets[pre]{bibid}[pre]{bibid}#*C
...
\citealts(pre){bibid}{bibid}#*C
\citealts(pre)(post){bibid}{bibid}#*C
\citealts(pre)(post)[pre]{bibid}[pre]{bibid}#*C
\citealts[pre]{bibid}[pre]{bibid}#*C
...
\citecs(pre){bibid}{bibid}#*C
\citecs(pre)(post){bibid}{bibid}#C
\citecs(pre)(post)[pre]{bibid}[pre]{bibid}#*C
\citecs[pre]{bibid}[pre]{bibid}#*C
\citecs[pre][post]{bibid}[pre][post]{bibid}#*C
\citecs(pre)(post)[pre][post]{bibid}[pre][post]{bibid}#C
\authornumcites{bibid}{bibid}#C
\authornumcites(pre){bibid}{bibid}#*C
\authornumcites(pre)(post){bibid}{bibid}#C
\authornumcites(pre)(post)[pre]{bibid}[pre]{bibid}#*C
\authornumcites[pre]{bibid}[pre]{bibid}#*C
