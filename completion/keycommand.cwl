...
\renewkeyenvironment{envname}[keys=defaults]{begindef}{enddef}
\renewkeyenvironment{envname}[keys=defaults][args]{begindef}{enddef}
\renewkeyenvironment{envname}[keys=defaults][OptKey][args]{begindef}{enddef}
\renewkeyenvironment[short-unexpand]{envname}[keys=defaults]{begindef}{enddef}#*
\renewkeyenvironment[short-unexpand]{envname}[keys=defaults][args]{begindef}{enddef}#*
\renewkeyenvironment[short-unexpand]{envname}[keys=defaults][OptKey][args]{begindef}{enddef}#*
\renewkeyenvironment*{envname}[keys=defaults]{begindef}{enddef}
\renewkeyenvironment*{envname}[keys=defaults][args]{begindef}{enddef}
\renewkeyenvironment*{envname}[keys=defaults][OptKey][args]{begindef}{enddef}
\renewkeyenvironment*[short-unexpand]{envname}[keys=defaults]{begindef}{enddef}#*
