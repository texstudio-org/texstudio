...
\inputSAScode{file}#i
\inputSAScode[options%keyvals]{file}#i
\inputSAScode*{file}#i
\inputSAScode*[options%keyvals]{file}#i
\inputSASoutput{file}#i
\inputSASoutput[options%keyvals]{file}#i
\inputSASoutput*{file}#i
\inputSASoutput*[options%keyvals]{file}#i
\inputRcode{file}#i
\inputRcode[options%keyvals]{file}#i
\inputRcode*{file}#i
\inputRcode*[options%keyvals]{file}#i
\inputRoutput{file}#i
\inputRoutput[options%keyvals]{file}#i
\inputRoutput*{file}#i
\inputRoutput*[options%keyvals]{file}#i
