...
public:
		...
		QFormatRange getFirstOverlayBetween(int start, int end, int preferredFormat = -1) const;
		QFormatRange getLastOverlayBetween(int start, int end, int preferredFormat = -1) const;
