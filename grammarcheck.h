...
enum GrammarErrorType { GET_UNKNOWN = 0, GET_WORD_REPETITION, GET_RESERVED, GET_BAD_WORD, GET_BACKEND, GET_BACKEND_SPECIAL1, GET_BACKEND_SPECIAL2, GET_BACKEND_SPECIAL3, GET_BACKEND_SPECIAL4};
