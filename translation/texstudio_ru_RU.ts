...
To revoke that choice, see [manual](%2)</source>
        <translation>Лог-файл не загружен из-за ограничения на размер (%1 МБ). Пользователь решил не загружать его и задал это опцией по умолчанию!
Чтобы изменить этот выбор, см. [руководство](%2)</translation>
    </message>
    <message>
