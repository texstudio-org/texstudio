...
<context>
    ...
    <message>
        ...
        <translation>TeXstudio использует DSingleApplication class (автор: Dima Fedorov Levit — копирайт (C) BioImage Informatics — лицензия: GPL).</translation>
    </message>
    <message>
...
&lt;b&gt;?m&quot;&lt;/b&gt; double-quoted filename without extension (identical to &lt;b&gt;%&lt;/b&gt;), &lt;b&gt;?me&lt;/b&gt; filename with extension (e.g. example.tex), &lt;b&gt;?*.aux&lt;/b&gt;: all .aux files in the current directory</source>
        <translation>&lt;i&gt;Селекторы&lt;/i&gt; — это комбинация: &lt;b&gt;a&lt;/b&gt; — абсолютного пути, &lt;!--&lt;i&gt;r&lt;/i&gt;: относительного пути, --&gt;&lt;b&gt;m&lt;/b&gt; — имени файла без расширения, &lt;b&gt;e&lt;/b&gt; — расширения, &lt;b&gt;r&lt;/b&gt; — относительного пути к мастер-файлу, &lt;b&gt;*&lt;/b&gt; — всех файлов, удовлетворяющих следующему критерию&lt;br /&gt;
добавьте &lt;b&gt;c:&lt;/b&gt;, чтобы использовать текущий файл вместо мастер-файла (включая двоеточие)&lt;br /&gt;
&lt;i&gt;Конечные символы:&lt;/i&gt; &lt;b&gt;)&lt;/b&gt; закрывает селектор. Следующие символы закрывают селектор и имеют дополнительное значение&lt;br /&gt;
&lt;b&gt;&quot;&lt;/b&gt; заключает в двойные кавычки, &lt;b&gt;.&lt;/b&gt; (точка) добавляет точку в конце, (пробел) добавляет пробел в конце&lt;br /&gt;
&lt;i&gt;Примеры:&lt;/i&gt; &lt;b&gt;?ame&quot;&lt;/b&gt; — полное абсолютное имя файла, заключённое в двойные кавычки, &lt;b&gt;?e)&lt;/b&gt; — просто расширение без предшествующей точки (например tex), &lt;br /&gt;
&lt;b&gt;?m&quot;&lt;/b&gt; — заключённое в двойные кавычки имя файла без расширения (равносильно &lt;b&gt;%&lt;/b&gt;), &lt;b&gt;?me&lt;/b&gt; — имя файла с расширением (например example.tex), &lt;b&gt;?*.aux&lt;/b&gt; — все файлы типа .aux в текущей папке</translation>
    </message>
    <message>
...
продолжает формировать символы. Поскольку LaTeX не имеет нативной поддержки Unicode, вам следует включить в документ пакеты, подходящие для символов Unicode.</translation>
    ...
    <message>
        ...
        <translation>Здесь можно настроить подсветку синтаксиса в своих окружениях.</translation>
    </message>
    <message>
...
&lt;/ul&gt;</translation>
    ...
    <message>
        ...
        <translation>Если все предложенные автодополнения содержат следующие символы, вы можете использовать &lt;Tab&gt;, чтобы автоматически вставить их.</translation>
    </message>
    <message>
...
*.dat</translation>
    ...
    <message>
        ...
        <translation>Будет принято решение на основе языка для проверки орфографии, используемого в документе.</translation>
    </message>
    <message>
...
Замечание: смена этой настройки повлияет только на документы, которые открыты после смены.</translation>
    ...
    <message>
        ...
        <translation>Замечание: оконный/панельный режимы настраиваются в Компиляция -&gt; Просмотрщик PDF</translation>
    </message>
    <message>
...
Are you sure you want accept data loss?</source>
        <translation>Если новая и старая кодировки несовместимы, некоторые буквы могут пропасть.
...
<context>
    ...
    <message>
        ...
        <translation>Разместить в окружении «figure»</translation>
    </message>
    <message>
...
[h] Here — в данном месте текста
[!] — игнорировать внутренние параметры, которые LaTeX использует для определения «хорошего» расположения плавающих элементов.

Замечание: этот порядок носит рекомендательный характер. Если в результате компоновка страницы окажется слишком плохой, LaTeX может проигнорировать это предложение. </translation>
    </message>
    <message>
...
Invalid \caption command.</source>
        <translation>Не удается обработать код включения графики:
отсутствует команда параметра \caption .</translation>
    </message>
    <message>
...
может привести к потере данных.
    ...
    <message>
        ...
        <translation>Создание файла резервной копии завершилось неудачей. Вы можете продолжать сохранение. Однако, если сохранение завершается неудачей, вы можете потерять данные в оригинальном файле. Хотите продолжить?</translation>
    </message>
    <message>
...
Возможно кто-то еще восстановил его и, следовательно, я пытаюсь перезаписать (возможно, модифицированную) версию на диске.</translation>
    </message>
    <message>
...
(Note: You can permanently enable silent reloading in the options.)</source>
        <translation>%1
был изменён другим приложением.

История Отмены/Повтора будет удалена при автообновлении.
Вы действительно хотите обновить файл?

(Замечание: вы можете включить постоянное обновление в настройках.)</translation>
    </message>
    <message>
...
Замечание: если этот размер больше расстояния между строками, то символы могут казаться обрезанными.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Для ключа можно указать лишь один символ</translation>
    </message>
    <message>
...
If not, they will not be available via the Make Template dialog.</source>
        <translation>Программа TeXstudio обнаружила пользовательские шаблоны в нерекомендованных местах.
...
не может быть удален.</translation>
    ...
    <message>
        ...
        <translation>Целевая папка не пуста. Рекомендуется использовать новую папку. В противном случае существующие файлы могут быть перезаписаны. Хотите ли вы по-прежнему использовать эту папку?</translation>
    </message>
    <message>
...
но вы используете версию TeXstudio, скомпилированную без встроенного просмотрщика PDF.</translation>
    </message>
    <message>
...
Press &quot;Cancel&quot;to do nothing.
        ...
        <translation>%1
был изменён другим приложением.
Нажмите «OK», чтобы показать отличия
...
Если выбрано «минимальная длина фразы», то показываются только фразы с длиной, не меньшей указанного числа символов, (напр., «a test» содержит 6 символов)
Если выбрано «минимальная длина слова (одного)», то показываются только фразы, в которых хотя бы одно слово имеет длину, не меньшую указанного числа символов (напр., «a test» содержит 4 символа)
Если выбрано «минимальная длина слов (всех)»,  то показываются только фразы, все слова которых имеют длину, не меньшую указанного числа символов (напр., «a test» содержит 1 символ)
Если выбрано «полностью игнорировать», то более короткие слова полностью игнорируются (напр., если задать длину 3, предложение «this is a test» равносильно предложению «this test», в то время как при других параметрах оно бы разделилось на «this is», «is a», «a test», даже если ни одна из этих фраз не была бы отображена)</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Команда браузера. Оставьте её пустой, чтобы не запускать браузер в конце конвертирования.</translation>
    </message>
    <message>
